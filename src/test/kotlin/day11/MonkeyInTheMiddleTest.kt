...
class Solver(private val data: List<String>) {
    ...
    fun solvePartTwo(): Long {
        ...
        // out that the LCM is actually the product of them all for both the example input and my input...
        // Not sure if this will work for everyone's input, but assuming all the inputs have about the same number of
        // monkeys, and assuming the test divisors are all relatively small numbers, this should be fine.
